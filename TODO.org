...
This is a packaging release.  No new functionality will be done
unless it is a huge bug.
...
installation.
  ...
  :CurrentDate:  <2011-01-24 Mon>
  :EndDate: <2011-01-30 Sun>
  :PERCENT: 0
  :CurrentVelocity: 0
  :NeededVelocity: 0
  :END:
...
|-----------------+-------+------+---------+---------+--------|
| * Version 0.5.1 |    10 |    0 |     0.0 |    0.00 |   1.67 |
...
*** TODO Put Gem in official repository [0/5]
    - [ ] Make dependencies for gtk2
    - [ ] Push to official repositories
    - [ ] Test on Linux and Windows to make sure it installs properly
    - [ ] Update documentation for Windows install
    - [ ] Document potential problems with debian and gem coexistance.
...
*** TODO Trim ruby-gtk2 install footprint
	ruby-gtk2 takes up 450 megs of disk space.  It should be at least
	200 megs smaller be getting rid of duplicate dlls.
...
*** TODO Write build instructions for Windows on ruby-gtk2
	Nobody knows how to build ruby-gtk2 on Windows.  Figure it
	out and write documentation.
...
*** TODO Streamlined Windows package
	Create a Windows package that contains only what is needed for
	JLDrill.  Everything should be included and it should take up
	less than 70 Megs installed.
