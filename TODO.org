...
|-------------------------+-------+------+------+---------+--------|
| * JLDrill Version 0.3.4 |    23 |   13 | 56.5 |    0.24 |   0.27 |
...
** TODO Be able to delete or edit an item from the "All Vocab" list.
   - Refactor widget to be a mixin
   - make gtkAdd/RemoveWidget have default values that log a warning
   - include Widget from GtkWidget
  :PROPERTIES:
  :JellyBeans: 2
  :END:
