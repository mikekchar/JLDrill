...
|-----------------+-------+------+---------+---------+--------|
| * Version 0.4.2 |    22 |   12 |    54.5 |    0.15 |   0.31 |
...
** TODO Use deinflection for dictionary searches [1/2]
   ...
   - [ ] Show the deinflection rules used in the output
