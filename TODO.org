...
|-----------------+-------+------+---------+---------+--------|
| * Version 0.3.5 |    38 |   18 |    47.4 |    0.09 |   0.18 |
...
** TODO Sort based on review rate
...
** TODO Time to learn after the first item is waaay too big (10798.7s) [0/1]
   - [ ] Refactor tests
