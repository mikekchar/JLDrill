...
|-------------------------+-------+------+------+---------+--------|
| * JLDrill Version 0.3.4 |    21 |   13 | 61.9 |    0.15 |   0.21 |
...
** TODO Be able to delete or edit an item from the "All Vocab" list. [10/11]
   ...
   - [ ] Create a "display only mode" for items that are being edited
     or added.
