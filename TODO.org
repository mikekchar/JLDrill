...
* Version 0.4.1
  ...
  The main purpose of this development release is to give more
...
This section lists important work that fell out of the previous
iteration for one reason or another.  It will be done in the next
development version.
