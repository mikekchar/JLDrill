...
|-------------------------+-------+------+------+---------+--------|
| * JLDrill Version 0.3.4 |    23 |   13 | 56.5 |    0.21 |   0.27 |
...
** TODO Be able to delete or edit an item from the "All Vocab" list. [5/8]
   ...
   - [-] Update the All Vocab list when things change.  Also select
		 the appropriate vocabulary when things change.
       - [X] Implement the ItemTableWindow as a window, not a dialog (duh...)
       - [ ] Updating the problem updates the All Vocab list
       - [ ] Updating a problem, selects it in the list
       - [ ] New problems select it in the list
       - [ ] Opening the list highlights the current problem
