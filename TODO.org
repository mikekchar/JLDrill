...
|-------------------------+-------+------+------+---------+--------|
| * JLDrill Version 0.3.4 |    23 |   13 | 56.5 |    0.23 |   0.27 |
...
** TODO Be able to delete or edit an item from the "All Vocab" list. [3/8]
   ...
   - [ ] Refactor VocabularyTable to hold items (rename it to ItemTable)
