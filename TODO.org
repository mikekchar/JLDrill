...
releases.  But we'll see how much time I have.
  ...
  :CurrentDate:  <2011-07-14 Thu>
  :EndDate: <2011-08-31 Wed>
  :PERCENT: 0
  :CurrentVelocity: 0
  :NeededVelocity: 0
  :END:
...
|-----------------+-------+------+---------+---------+--------|
| * Version 0.5.2 |    19 |    2 |    10.5 |    2.00 |   0.40 |
...
*** TODO Show appropriate examples when the question is shown
	When the question is shown, show the English side of the
	examples when it is a meaning question, Japanese side of the
	example when it is a Kanji question and Japanese with
	header if it is a reading question.  Fill in the rest of
	the details when the answer is shown.
...
*** TODO Move to Ruby 1.9
	Currently using Ruby 1.8.7 Move to Ruby 1.9.  This should
	improve performance somewhat.  This needs to be done before
	Debian moves over to Ruby 1.9 as its standard.
