...
|-----------------+-------+------+---------+---------+--------|
| * Version 0.4.1 |    20 |   17 |    85.0 |    0.13 |   0.12 |
...
** TODO Automatically load dictionary option [2/4]
   ...
   - [ ] Automatically load dictionary when loading the file
   - [ ] Automatically load dictionary when dictionary changes in the options
