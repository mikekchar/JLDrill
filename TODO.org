...
* JLDrill Version 0.3.4
  ...
  :CurrentDate:  <2009-08-28 Fri>
  :EndDate: <2009-09-04 Fri>
  :PERCENT: 0
  :CurrentVelocity: 0
  :NeededVelocity: 0
  :END:
...
|-------------------------+-------+------+-------+---------+--------|
| * JLDrill Version 0.3.4 |    21 |   21 | 100.0 |    0.09 |   0.08 |
...
** DONE Delete doesn't work properly from the all vocab list.
   After you delete you have two tables.

** DONE Need a delete button on the all vocab list.
