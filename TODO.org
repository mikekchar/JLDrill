...
** TODO Be able to delete or edit an item from the "All Vocab" list. [4/9]
   ...
   - [-] Make dictionary searches return item lists
       ...
       - [ ] Create a hash table to contain status information for
         each drill
       - [ ] Move ItemStatus into the Quiz directory and make it
         totally related to that Quiz
       - [ ] Move the Quiz.rb file out of Quiz and refactor it to be a
         generic Quiz.
       - [ ] Rename position to be origPos
   - [ ] Unscheduled items in Bin 4 should be scheduled when read in.
