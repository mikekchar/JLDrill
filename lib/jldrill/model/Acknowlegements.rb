...
Acknowledgement is also necessary for the Tatoeba project and
contributors for the original Tanaka corpus which supply the example
senteces in this software.
...
I am also indebted to Polar Cloud for writing the excellent
FireFox plugin, Rikaichan.  I have used several of the ideas
and even some of the datafiles from this project.
...
The Tatoeba project can be found here:

* [Tatoeba.org](http://tatoeba.org)

The data in this project is made available under a Creative Commons
