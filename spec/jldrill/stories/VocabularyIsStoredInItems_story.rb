...
###########################################
    ...
    describe Story.stepName("Items can hold Vocabulary") do
        it "should be able to create an Item from a Vocabulary" do
            vocabString = "/Kanji: 会う/Reading: あう/Definitions: to meet,to interview/Markers: v5u,P/Position: 2/Consecutive: 1/Score: 0/Level: 0/Difficulty: 0/\n"
        ...
        it "should be able to see if items are equal" do
            ...
            v1 = "/Kanji: 会う/Reading: あう/Definitions: to meet,to interview/Markers: v5u,P/Position: 2/Consecutive: 1/Score: 0/Level: 0/Difficulty: 0/\n"
            v2 = "/Kanji: 会う/Reading: あう/Definitions: to meet,to interview/Markers: v5u,P/Position: 3/Consecutive: 0/Score: 2/Level: 1/Difficulty: 4/\n"
            v3 = "/Kanji: 雨/Reading: あめ/Definitions: rain/Markers: n,P/Position: 2/Consecutive: 1/Score: 0/Level: 0/Difficulty: 0/\n"
