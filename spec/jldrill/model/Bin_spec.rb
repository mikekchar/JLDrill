...
module JLDrill
	...
	describe Bin do
		...
		before(:each) do
        	@fileString = %Q[/Kanji: 会う/Reading: あう/Definitions: to meet,to interview/Markers: v5u,P/Position: 1/Consecutive: 0/Score: 0/Level: 0/Difficulty: 3/
/Kanji: 青い/Reading: あおい/Definitions: blue,pale,green,unripe,inexperienced/Markers: adj,P/Position: 2/Consecutive: 0/Score: 0/Level: 0/Difficulty: 3/
/Kanji: 赤い/Reading: あかい/Definitions: red/Markers: adj,P/Position: 3/Consecutive: 0/Score: 0/Level: 0/Difficulty: 3/
/Kanji: 明い/Reading: あかるい/Definitions: bright,cheerful/Markers: adj/Position: 4/Consecutive: 1/Score: 0/Level: 0/Difficulty: 3/]
		...
		contentsString = %Q[/Kanji: 会う/Reading: あう/Definitions: to meet,to interview/Markers: v5u,P/Position: 1/Consecutive: 0/Score: 0/Level: 0/Difficulty: 3/
/Kanji: 青い/Reading: あおい/Definitions: blue,pale,green,unripe,inexperienced/Markers: adj,P/Position: 2/Consecutive: 0/Score: 0/Level: 0/Difficulty: 3/
/Kanji: 赤い/Reading: あかい/Definitions: red/Markers: adj,P/Position: 3/Consecutive: 0/Score: 0/Level: 0/Difficulty: 3/
/Kanji: 明い/Reading: あかるい/Definitions: bright,cheerful/Markers: adj/Position: 4/Consecutive: 1/Score: 0/Level: 0/Difficulty: 3/]
		    test_pushAll
        ...
        it "should be able to tell if an item exists in the bin" do
            ...
            @bin.contain?(Vocabulary.create("/Kanji: 雨/Reading: あめ/Definitions: rain/Markers: n,P/Position: 1/Consecutive: 0/Score: 0/Level: 0/Difficulty: 3/")).should be(false)
        end
	end
end
